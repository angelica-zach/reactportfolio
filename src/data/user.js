const INFO = {
	...
	projects: [
...

		{
			...
			description:
				"Weather site that allows location input, which then calls the Open Weather API to display a 5 day forecast. Last 5 searches saved and displayed for easy access to recall and redisplay",
			linkText: "View Project",
